...
# create phyloseq object with mock samples
mock <- subset_samples(physeq3, mock_community == "yes")

# create phyloseq object with mock OTUs
filter <- phyloseq::genefilter_sample(mock, filterfun_sample(function(x) x > 300))
mock_taxa <- prune_taxa(filter, mock)

# remove MOCK communities OTUs
no_mock_taxa <- prune_taxa(!filter, physeq3)

# remove MOCK samples
psdata_RBRA <- subset_samples(no_mock_taxa, mock_community == "no")
```
...
ggsave("C:/Users/Rita/Documents/R/Manuscript_1/figures/Figure1_S1.pdf", width = 5, height = 3)
```
...
ggsave("C:/Users/Rita/Documents/R/Manuscript_1/figures/Figure1_4A.pdf", width = 2.5, height = 2.5)
```
...
ggsave("C:/Users/Rita/Documents/R/Manuscript_1/figures/Figure1_4A.pdf", width = 2.5, height = 5)
```
...
ggsave("C:/Users/Rita/Documents/R/Manuscript_1/figures/Figure1_4BC.pdf", width = 8, height = 4)
```
...
ggsave("C:/Users/Rita/Documents/R/Manuscript_1/figures/Figure1_4DE.pdf", width = 8, height = 4.5)
```

**Figure 4D and 4E**. B) Jaccard and C) unweighted UniFrac distances between each inoculum and respective derived microbial communities under different redox conditions, this difference between B) and C) represents the phylogenetic clustering of the observed ASVs.<br>
...
# chemical data
chem_data = readxl::read_xlsx("C:/Users/Rita/Documents/R/Manuscript_1/input_data/Article1_chemical_data.xlsx")
...
anova_tab_red_kable <- anova_tab_red %>% 
...
ggsave("C:/Users/Rita/Documents/R/Manuscript_1/figures/Figure1_5.pdf", width = 12, height = 5)
```
...
ggsave("C:/Users/Rita/Documents/R/Manuscript_1/figures/Figure1_S4.pdf", width = 8, height = 4)
```
...
ggsave("C:/Users/Rita/Documents/R/Manuscript_1/figures/Figure1_S5.pdf", width = 8, height = 4)
```
